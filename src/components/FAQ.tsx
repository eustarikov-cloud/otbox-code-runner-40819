...
const faqs = [
  ...
  },
  {
    ...
    answer: "Пакет содержит инструкции для парикмахеров, администраторов, специалистов по косметологии, формы учёта, планы эвакуации, а также документы по пожарной и электробезопасности.",
  },
  {
  ...
  },
  {
    ...
    answer: "Все шаблоны актуальны на 2025 год, соответствуют ТК РФ и актам Минтруда. Регулярно обновляем при изменении законодательства.",
  },
  {
  ...
  },
  {
    ...
    answer: "Да, мы предоставляем демо-пакет с фрагментами документов. Напишите нам для получения образца.",
  },
];
