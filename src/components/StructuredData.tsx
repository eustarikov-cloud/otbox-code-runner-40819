...
export const StructuredData = () => {
  useEffect(() => {
    ...
    const faqSchema = {
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Пакет содержит инструкции для парикмахеров, администраторов, специалистов по косметологии, формы учёта, планы эвакуации, а также документы по пожарной и электробезопасности."
          }
        },
        {
          "@type": "Question",
    ...
    const officeProductSchema = {
      ...
      "description": "Полный пакет документов по охране труда для офиса: 165+ документов, соответствие ТК РФ 2025, доставка за 5 минут",
      "brand": {
        "@type": "Brand",
        "name": "OT-Box"
      },
    ...
    const salonProductSchema = {
      ...
      "description": "Специализированный пакет документов по охране труда для салонов красоты: 180+ документов, соответствие ТК РФ 2025",
      "brand": {
        "@type": "Brand",
        "name": "OT-Box"
      },
